...
export class CreatePurchaseComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  adquiridasColumns: any[] =
    [
      ...
      { text: 'Descripcion', datafield: 'codigo_padre' }
    ];
  ...
  constructor(private declareList: DeclarationService,
    ...
    this.formFeildList = [
      ...
      {
        name: 'minimo_retencion',
        title: 'Vr Minimo Retencion',
        inputType: 'text',
        width: 25,
        value: '',
        required: ' Required'
      ...
      {
        name: 'ciudad_regalias',
        title: 'Ciudad Regalías',
        inputType: 'lists',
        width: 25,
        value: '',
        required: ' Required'
